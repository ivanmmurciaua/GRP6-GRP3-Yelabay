<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="VerOrdenadores.aspx.cs" Inherits="webYelabay.VerOrdenadores" %>
    ...
    <div id ="innerContainer">
        ...
        <div id="content">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:miconexion %>" SelectCommand="SELECT * FROM [Productos] WHERE ([fkcategoria] = @fkcategoria)">
                <SelectParameters>
                    <asp:Parameter DefaultValue="2" Name="fkcategoria" Type="Int32" />
                </SelectParameters>
            </asp:SqlDataSource>
