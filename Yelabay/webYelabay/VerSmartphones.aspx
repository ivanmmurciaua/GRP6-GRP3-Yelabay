<%@ Page Language="C#" MasterPageFile="~/Site1.Master" AutoEventWireup="true" CodeBehind="VerSmartphones.aspx.cs" Inherits="webYelabay.VerSmartphones" %>
    ...
    <div id ="innerContainer">
        ...
        <div id="content">
            ...
            <asp:SqlDataSource ID="SqlDataSource1" runat="server" ConnectionString="<%$ ConnectionStrings:miconexion %>" SelectCommand="SELECT * FROM [Productos] WHERE ([fkcategoria] = @fkcategoria)">
                <SelectParameters>
                    <asp:Parameter DefaultValue="3" Name="fkcategoria" Type="Int32" />
                </SelectParameters>
            </asp:SqlDataSource>
